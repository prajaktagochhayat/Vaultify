    ...
    <div className="min-h-screen bg-warm-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl border border-brand-100 p-8 max-w-md w-full space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-brand-900 tracking-tight">Create Vaultify Account</h2>
          <p className="text-xs font-medium text-gray-500">Get 5 GB free encrypted cloud storage</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="w-4 h-4 text-brand-400 absolute left-3.5 top-1/2 -translate-y-1/2" />
              <input
                type="text"
          ...
          >
            {loading ? 'Creating Vault...' : 'Create Free Vault'}
